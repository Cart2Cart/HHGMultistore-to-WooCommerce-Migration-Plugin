 ...
 */
/*
Plugin Name: Cart2Cart: H.H.G. Multistore to WooCommerce Migration Module
...
function cart2cart_config(){
	...
	$sourceCartName = 'H.H.G. Multistore';
	$referertext = 'Cart2Cart: '. $sourceCartName  . ' to '. $cartName  . ' Module';
	$sourceCartLogo = 'http://www.shopping-cart-migration.com/images/stories/hhgmultistore.gif';
    $sourceCartNameLink = 'hhgmultistore';
